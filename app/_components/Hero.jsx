  ...
  return (
    <div className='flex flex-col justify-center items-center my-20'>
      <div className='hidden lg:block'>
        <Image src='/profile-1.png' width={115} height={115}
          className='h-[120px] object-cover rounded-full absolute right-36' />
        <Image src='/profile-4.png' width={115} height={115}
          className='h-[110px] object-cover rounded-full absolute top-48 left-16' />
        <Image src='/profile-2.png' width={150} height={150}
          className='h-[160px] object-cover rounded-full absolute bottom-20 left-36' />
        <Image src='/profile-3.png' width={100} height={100}
          className='h-[100px] object-cover rounded-full absolute right-16 bottom-32' />
      </div>
      <div className='text-center max-w-3xl'>
        <h2 className='font-bold text-[60px] text-slate-700'>The thoughtful way
          to find a time to meet</h2>
